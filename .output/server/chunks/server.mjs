...
const components = {};
function componentsPlugin_966cbada(nuxtApp) {
...
const vueuseHead_25605f65 = defineNuxtPlugin((nuxtApp) => {
...
const _7678fd4e = defineNuxtPlugin((nuxtApp) => {
...
const _99837b74 = defineNuxtPlugin((nuxtApp) => {
