...
const _lazy_287612 = () => import('./renderer.mjs').then(function (n) { return n.a; });

const handlers = [
  { route: '', handler: _152570, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_287612, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_287612, lazy: true, middleware: false, method: undefined }
];
